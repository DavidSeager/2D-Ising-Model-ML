This repository investigates the Ising model with the use of machine learning. 2D Ising models are generated at various temperatures which are then fed into a simple autoencoder. The 
